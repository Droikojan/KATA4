 ...
 * presents it as an {@link IntervalXYDataset}, allowing a set of tasks to be
 * displayed using an {@link XYBarRenderer} (and usually a {@link SymbolAxis}).
 * This is a very specialised dataset implementation ---before using it, you
 * should take some time to understand the use-cases that it is designed for.
 *
 * @since 1.0.11
 */
public class XYTaskDataset extends AbstractXYDataset
     ...
     * The default is
     * <code>false</code> which means the x-values are integers corresponding to
     * the series indices, and the y-values are millisecond values corresponding
     * to the task date/time intervals. If the flag is set to
     * <code>true</code>, the x and y-values are reversed.
     *
     * @return The flag.
     *
    ...
    /**
     * Sets the flag that controls whether or not the dataset is transposed and
    ...
    /**
     * Returns the starting date/time for the specified item (task) in the given
     * series, measured in milliseconds since 1-Jan-1970 (as in java.util.Date).
     *
    ...
    /**
     * Returns the ending date/time for the specified item (task) in the given
     * series, measured in milliseconds since 1-Jan-1970 (as in java.util.Date).
     *
     * @param series the series index.
     * @param item the item (or task) index.
    ...
    /**
     * Returns the starting value of the y-interval for an item in the given
     * series.
     *
     * @param series the series index.
     * @param item the item (or task) index.
    ...
    /**
     * Returns the ending value of the y-interval for an item in the given
     * series.
     *
     * @param series the series index.
     * @param item the item (or task) index.
