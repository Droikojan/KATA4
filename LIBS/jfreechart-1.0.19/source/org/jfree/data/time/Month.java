...
public class Month extends RegularTimePeriod implements Serializable {
    ...
    /**
     * Constructs a new
     * <code>Month</code> instance, based on a date/time and the default time
     * zone.
     *
    ...
    /**
     * Constructs a new
     * <code>Month</code> instance, based on a date/time and a time zone. The
     * first and last millisecond values are initially pegged to the given time
     * zone also.
     *
    ...
    /**
     * Creates a new
     * <code>Month</code> instance, based on the specified time, zone and
     * locale.
     *
    ...
    /**
     * Creates a year from a string, or returns
     * <code>null</code> (format exceptions suppressed).
     *
     * @param s the string to parse.
     *
