...
public class OHLCSeriesCollection extends AbstractXYDataset
     ...
     * <code>OHLCSeriesCollection</code>.
     */
    ...
    /**
     * Returns
     * <code>null</code> always, because this dataset doesn't record any volume
     * data.
     *
    ...
    /**
     * Returns
     * <code>Double.NaN</code> always, because this dataset doesn't record any
     * volume data.
     *
     * @param series the series index (ignored).
     * @param item the item index (ignored).
