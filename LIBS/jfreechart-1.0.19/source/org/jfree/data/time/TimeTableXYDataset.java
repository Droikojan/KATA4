 ...
 * to share the same set of x-values. When adding a new item
 * <code>(x, y)</code> to one series, all other series automatically get a new
 * item
 * <code>(x, null)</code> unless a non-null item has already been specified.
 *
