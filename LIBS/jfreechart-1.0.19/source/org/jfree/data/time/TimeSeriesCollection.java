...
public class TimeSeriesCollection extends AbstractIntervalXYDataset
     ...
     * is true, only the x-value is used to determine the range of values in the
     ...
     * domain. If
     * <code>true</code>, then only the x-values are considered for the max and
     * min values. If
     * <code>false</code>, then the start and end x-values will also be taken
     * into consideration.
     *
     * @return The flag.
     *
     ...
     * <code>null</code> if there is no such series.
     *
