...
public class TimeSeries extends Series implements Cloneable, Serializable {
     ...
     * <code>Domain</code>) to all registered property change listeners.
     *
     ...
     * <code>PropertyChangeEvent</code> (with the property name
     * <code>Range</code>) to all registered listeners.
     *
     * @param description the description (<code>null</code> permitted).
     *
    ...
    /**
     * Returns the range of y-values in the time series. Any
     * <code>null</code> data values in the series will be ignored (except for
     * the special case where all data values are
     * <code>null</code>, in which case the return value is
     * <code>Range(Double.NaN, Double.NaN)</code>). If the time series contains
     * no items, this method will return
     * <code>null</code>.
     *
     ...
     *
     * @param xRange the subrange of x-values (<code>null</code> not permitted).
     ...
     * permitted).
     * @param xAnchor the anchor point for the x-values (<code>null</code> not
     * permitted).
     ...
     * <code>null</code> and
     * <code>Double.NaN</code> values. This method returns
     * <code>Double.NaN</code> if there is no smallest y-value (for example,
     ...
     * <code>null</code> and
     * <code>Double.NaN</code> values. This method returns
     * <code>Double.NaN</code> if there is no largest y-value (for example, when
     * the series is empty).
     *
     ...
     *
     * @return The time period class (may be <code>null</code> but only for an
     * empty series).
     */
     ...
     * specified period, this method will return
     * <code>null</code>.
     *
     ...
     *
     * @param notify controls whether or not a {@link SeriesChangeEvent} is sent
     * to registered listeners IF any items are removed.
     */
     ...
     * <code>timePeriodClass</code> as this will be inferred when the first data
     * item is added to the dataset.
     */
