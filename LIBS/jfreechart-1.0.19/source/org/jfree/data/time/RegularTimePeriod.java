...
public abstract class RegularTimePeriod implements TimePeriod, Comparable,
     ...
     * <code>null</code> if some lower limit has been reached.
     *
     ...
     * <code>null</code> if some limit has been reached.
     *
     ...
     * <code>Date</code> instance every time it is called.
     *
     ...
     * @return The first millisecond of the time period.
     *
     * @deprecated As of 1.0.3, you should avoid using this method (it creates a
     * new Calendar instance every time it is called). You are advised to call
     * {@link #getFirstMillisecond(Calendar)} instead.
     *
     ...
     * @deprecated As of 1.0.3, you should avoid using this method (it creates a
     * new Calendar instance every time it is called). You are advised to call
     * {@link #getLastMillisecond(Calendar)} instead.
     *
     ...
     * @deprecated As of 1.0.3, you should avoid using this method (it creates a
     * new Calendar instance every time it is called). You are advised to call
     * {@link #getMiddleMillisecond(Calendar)} instead.
     */
     ...
     * specified
     * <code>anchor</code> using the supplied
     * <code>calendar</code> (which incorporates a time zone).
     *
