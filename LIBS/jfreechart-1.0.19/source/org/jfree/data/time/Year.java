...
public class Year extends RegularTimePeriod implements Serializable {
    ...
    /**
     * Creates a new
     * <code>Year</code>, based on the current system date/time.
     */
    public Year() {
        this(new Date());
    }
    ...
    /**
     * Creates a new
     * <code>Year</code>, based on a particular instant in time, using the
     * default time zone.
     *
    ...
    /**
     * Creates a new
     * <code>Year</code> instance, for the specified time zone and locale.
     *
     ...
     * <code>Year</code> object to an arbitrary object. Returns
     * <code>true</code> if the target is a
     * <code>Year</code> instance representing the same year as this object. In
     ...
     * <code>Year</code> object relative to the specified object:
     *
