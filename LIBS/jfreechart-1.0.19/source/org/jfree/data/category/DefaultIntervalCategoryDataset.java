...
public class DefaultIntervalCategoryDataset extends AbstractSeriesDataset
     ...
     *
     * @param seriesKeys the series keys (if <code>null</code>, series keys will
     ...
     * length of the array must match the number of series in the dataset).
     *
    ...
    /**
     * Clones a two dimensional array of
