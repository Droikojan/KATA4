...
public class CategoryToPieDataset extends AbstractDataset
     ...
     * If
     * <code>source</code> is
     * <code>null</code>, the created dataset will be empty.
     *
     * @param source the source dataset (<code>null</code> permitted).
     * @param extract extract data from rows or columns? (<code>null</code> not
     * permitted).
     ...
     * <code>-1</code> if there is no such key.
     *
     * @param key the key.
     *
     ...
     * <code>null</code>, this method returns an empty list.
     *
     * @return The keys.
     */
    @Override
     ...
     * <code>null</code> (but note that
     * <code>null</code> can be associated with a valid key also).
     *
     * @param key the key.
     *
     * @return The value (possibly <code>null</code>).
     ...
     * <code>true</code> if
     * <code>obj</code> is a dataset containing the same keys and values in the
     * same order as this dataset.
     *
