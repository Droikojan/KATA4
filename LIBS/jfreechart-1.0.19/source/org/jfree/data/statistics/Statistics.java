...
public abstract class Statistics {
     ...
     *
     * @param values the values ({@code null} not permitted).
     * @param includeNullAndNaN a flag that controls whether or not {@code null}
     * and {@code Double.NaN} values are included in the calculation (if either
     * is present in the array, the result is {@link Double#NaN}).
     *
     * @return The mean.
     *
     * @since 1.0.3
     ...
     *
     * @param data the data ({@code null} or zero length array not permitted).
     *
