...
public class NonGridContourDataset extends DefaultContourDataset {
    ...
    /**
     * Builds a regular grid. Maps the non-grid data into the regular grid using
     * an inverse distance between grid and non-grid points. Weighting of
     * distance can be controlled by setting through the power parameter that
     * controls the exponent used on the distance weighting (e.g.,
     * distance^power).
     *
