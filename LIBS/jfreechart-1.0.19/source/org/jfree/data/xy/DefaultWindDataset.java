...
public class DefaultWindDataset extends AbstractXYDataset
     ...
     * <code>Date</code> or a
     * <code>Number</code> that is the milliseconds since 1-Jan-1970);</li>
     * <li><code>data[series][item][1]</code> - the wind direction (1 - 12, like
     * the numbers on a clock face);</li>
    ...
    /**
     * Checks this
     * <code>WindDataset</code> for equality with an arbitrary object. This
     * method returns
...
class WindDataItem implements Comparable, Serializable {
    ...
    /**
     * Tests this
     * <code>WindDataItem</code> for equality with an arbitrary object.
     *
     * @param obj the object (<code>null</code> permitted).
     *
     * @return A boolean.
