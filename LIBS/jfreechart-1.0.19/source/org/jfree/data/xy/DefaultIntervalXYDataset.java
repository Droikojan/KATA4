...
public class DefaultIntervalXYDataset extends AbstractIntervalXYDataset
    ...
    /**
     * Creates a new
     * <code>DefaultIntervalXYDataset</code> instance, initially containing no
     * data.
     */
     ...
     * @throws ArrayIndexOutOfBoundsException if <code>item</code> is not within
     * the specified range.
     *
     * @see #getX(int, int)
     */
     ...
     * arrays of equal length, the first three containing the x-values (x, xLow
     * and xHigh) and the last three containing the y-values (y, yLow and
     * yHigh)).
     */
    ...
    /**
     * Tests this
     * <code>DefaultIntervalXYDataset</code> instance for equality with an
     * arbitrary object. This method returns
     * <code>true</code> if and only if:
     * <ul>
     * <li><code>obj</code> is not
     * <code>null</code>;</li>
