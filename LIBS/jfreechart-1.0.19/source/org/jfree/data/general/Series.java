...
public abstract class Series implements Cloneable, Serializable {
     ...
     * <code>VetoableChangeEvent</code> (with the property name "Key") to all
     * registered listeners. For backwards compatibility, this method also fires
     * a regular
     * <code>PropertyChangeEvent</code>. If the key change is vetoed this method
    ...
    /**
     * Returns
     * <code>true</code> if the series contains no data items, and
