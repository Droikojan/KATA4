...
public final class DatasetUtilities {
     ...
     * dataset contains negative or
     * <code>null</code> values, they are ignored.
     *
     ...
     * array (instances of
     * <code>Double</code> are created to represent the data items).
     * <p>
     ...
     * @param seriesKey the key to give the resulting series (<code>null</code>
     * not permitted).
     *
     * @return A dataset.
     */
    ...
    /**
     * Returns
     * <code>true</code> if the dataset is empty (or
     * <code>null</code>), and
     ...
     * <code>dataset</code> taking into account only the visible series and
     * including any x-interval if requested.
     *
     * @param dataset the dataset (<code>null</code> not permitted).
     ...
     * {@link IntervalXYDataset}, whether the x-interval or just the x-value is
     ...
     * @param dataset the dataset (<code>null</code> not permitted).
     * @param includeInterval a flag that determines, for an
     * {@link IntervalXYDataset}, whether the y-interval or just the y-value is
     * used to determine the overall range.
     *
     * @return The range (possibly <code>null</code>).
     *
     ...
     * permitted).
     * @param includeInterval a flag that determines whether or not the
     * y-interval for the dataset is included (this only applies if the dataset
     * is an instance of IntervalXYDataset).
     *
     ...
     * @param xRange the x-range (<code>null</code> not permitted).
     * @param includeInterval a flag that determines whether or not the
     * z-interval for the dataset is included (this only applies if the dataset
     * has an interval, which is currently not supported).
     *
     * @return The y-range (possibly <code>null</code>).
     */
     ...
     * it involves iterating over the entire data-set. Returns
     * <code>null</code> if all the data values in the dataset are
     * <code>null</code>.
     *
     * @param dataset the dataset (<code>null</code> not permitted).
     ...
     * involves iterating over the entire data-set. Returns
     * <code>null</code> if all the data values in the dataset are
     * <code>null</code>.
     *
     * @param dataset the dataset (<code>null</code> not permitted).
     ...
     * involves iterating over the entire data-set. Returns
     * <code>null</code> if all the data values are
     * <code>null</code>.
     *
     * @param dataset the dataset (<code>null</code> not permitted).
     *
     ...
     * x-values for the dataset, this method returns
