...
public abstract class AbstractDataset implements Dataset, Cloneable,
     ...
     * <code>true</code>. If this is
     * <code>false</code>, calls to the {@link #fireDatasetChanged()} method
     * will NOT trigger a dataset change event.
     *
     * @return A boolean.
     *
     * @since 1.0.17
     ...
     * {@link #fireDatasetChanged()} method notifies listeners. Setting this
     * flag to
     * <code>true</code> will trigger a
     * <code>DatasetChangeEvent</code> because there may be queued up changes.
     *
    ...
    /**
     * Notifies all registered listeners that the dataset has changed, provided
     * that the
     * <code>notify</code> flag has not been set to
     * <code>false</code>.
     *
     * @see #addChangeListener(DatasetChangeListener)
     */
