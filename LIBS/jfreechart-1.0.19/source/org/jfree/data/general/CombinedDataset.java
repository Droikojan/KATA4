 ...
 * under one dataset.
 *
 * @deprecated As of version 1.0.13. This class will be removed from JFreeChart
 * 1.2.0 onwards. Anyone needing this facility will need to maintain it outside
 * of JFreeChart.
 */
public class CombinedDataset extends AbstractIntervalXYDataset
     ...
     * <P>
     * Note: throws
     * <code>ClassCastException</code> if the series is not from a
     * {@link XYDataset}.
     *
     ...
     * parent, or a child is found that is not a CombinationDataset, then
     * returns
     * <code>null</code>.
     *
