...
public strictfp class Range implements Serializable {
    ...
    /**
     * Returns
     * <code>true</code> if the range contains the specified value and
    ...
    /**
     * Returns
     * <code>true</code> if the range intersects with the specified range, and
     * <code>false</code> otherwise.
     *
     ...
     * Note that:
     * <ul>
     * <li>either range can be
     * <code>null</code>, in which case the other range is returned;</li>
     * <li>if both ranges are
     ...
     * <code>range</code> AND the specified
     * <code>value</code>.
     *
    ...
    /**
     * Returns the given
     * <code>value</code> adjusted by
     * <code>delta</code> but with a check to prevent the result from crossing
     * <code>0.0</code>.
     *
     * @param value the value.
    ...
    /**
     * Returns
     * <code>true</code> if both the lower and upper bounds are
     * <code>Double.NaN</code>, and
     * <code>false</code> otherwise.
     *
     * @return A boolean.
     *
