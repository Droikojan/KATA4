...
public class FXGraphics2D extends Graphics2D {
     ...
     * is set to 0.0f, the stroke is rendered as the thinnest possible line for
     * the target device and the antialias hint setting." We don't have a means
     * to implement that accurately since we must specify a fixed width to the
     ...
     * handling for {@code RoundRectangle2D},
     * {@code Rectangle2D}, {@code Ellipse2D} and {@code Arc2D}. All other
     * shapes are mapped to a path outline and then filled.
     *
     * @param s the shape ({@code null} not permitted).
     *
