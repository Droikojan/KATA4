...
public class ChartPanel extends JPanel implements ChartChangeListener,
     ...
     * used, more memory is consumed, but panel repaints will be a lot quicker
     * in cases where the chart itself hasn't changed (for example, when another
     ...
     * is used (read the warning above before setting this to <code>false</code>).
     */
    ...
    /**
     * Returns
     * <code>true</code> if OrsonPDF is on the classpath, and
