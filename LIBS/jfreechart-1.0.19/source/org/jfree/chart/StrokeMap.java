 ...
 * <code>Comparable</code> instances with
 * <code>Stroke</code> instances.
 * <br><br>
 * To support cloning and serialization, you should only use keys that are
 * cloneable and serializable. Special handling for the
 * <code>Stroke</code> instances is included in this class.
 *
 * @since 1.0.3
 */
public class StrokeMap implements Cloneable, Serializable {
    ...
    /**
     * Returns
     * <code>true</code> if the map contains the specified key, and
