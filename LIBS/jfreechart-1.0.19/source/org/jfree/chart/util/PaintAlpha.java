...
public class PaintAlpha {
    ...
    /**
     * Per default
     * <code>PaintAlpha</code> will try to honour alpha-channel information. In
     * the past this was not the case. If you wish legacy functionality for your
     * application you can request this here.
     *
     ...
     * <code>Paint</code> of the same Type. If the Type is not supported, the
     * original
     * <code>Paint</code> is returned.
     * <p>
     *
    ...
    /**
     * Create a new
     * <code>GradientPaint</code> with its colors darkened.
     *
    ...
    /**
     * Create a new
     * <code>TexturePaint</code> with its colors darkened.
     * <p>
     * This entails cloning the underlying
     * <code>BufferedImage</code>, then darkening each color-pixel individually!
     *
     ...
     * known Color Models<br> null     ({@link java.awt.image.IndexColorModel     IndexColorModel},
