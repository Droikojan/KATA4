...
/**
 * Some
 * <code>AttributedString</code> utilities.
 *
 * @since 1.0.16
 */
public class AttrStringUtils {
     ...
     * <code>(x, y)</code>, rotated by the specified angle about
     * <code>(x, y)</code>.
     *
     * @param text the attributed string (<code>null</code> not permitted).
    ...
    /**
     * Draws the attributed string at
     * <code>(textX, textY)</code>, rotated by the specified angle about
     * <code>(rotateX, rotateY)</code>.
     *
     * @param text the attributed string (<code>null</code> not permitted).
     * @param g2 the graphics output target.
