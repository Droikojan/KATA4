...
public class URLUtilities {
    ...
    /**
     * Calls
     * <code>java.net.URLEncoder.encode(String, String)</code> via reflection,
     * if we are running on JRE 1.4 or later, otherwise reverts to the
     * deprecated
     * <code>URLEncoder.encode(String)</code> method.
     *
