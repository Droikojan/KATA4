...
public class SymbolAxis extends NumberAxis implements Serializable {
    ...
    /**
     * Returns
     * <code>true</code> if the grid bands are showing, and
     ...
     * <CODE>DEFAULT_GRID_BAND_PAINT</CODE> by default).
     *
     ...
     * <code>null</code> not permitted).
     * @param firstGridBandIsDark True: the first grid band takes the color      * of <CODE>gridBandPaint</CODE>. False: the second grid band takes
     * the color of <CODE>gridBandPaint</CODE>.
