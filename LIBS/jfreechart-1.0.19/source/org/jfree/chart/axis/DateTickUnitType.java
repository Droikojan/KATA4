...
public class DateTickUnitType implements Serializable {
     ...
     * Hour.
     */
    public static final DateTickUnitType HOUR = new DateTickUnitType("DateTickUnitType.HOUR",
     ...
     * Millisecond.
     */
    public static final DateTickUnitType MILLISECOND = new DateTickUnitType("DateTickUnitType.MILLISECOND",
    ...
    /**
     * Returns
     * <code>true</code> if this object is equal to the specified object, and
