...
public class CyclicNumberAxis extends NumberAxis {
     ...
     *
     * @return <code>true</code> if the cycle bound is mapped to the last cycle, <code>false</code> if it is bound to the current cycle
     * (default)
     */
    ...
    public double getCycleBound() {
        return Math.floor(
                (getRange().getUpperBound() - this.offset) / this.period) * this.period + this.offset;
    }
