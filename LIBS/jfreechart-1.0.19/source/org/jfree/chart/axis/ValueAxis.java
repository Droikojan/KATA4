 ...
 * using the
 * <code>double</code> primitive. The two key subclasses are {@link DateAxis}
 * and {@link NumberAxis}.
 */
public abstract class ValueAxis extends Axis
    ...
    /**
     * Returns
     * <code>true</code> if the tick labels should be rotated (to vertical), and
    ...
    /**
     * Sets the auto range attribute. If the
     * <code>notify</code> flag is set, an {@link AxisChangeEvent} is sent to
     * registered listeners.
     *
     * @param auto the flag.
     ...
     * all registered listeners. Furthermore, if
     * <code>turnOffAutoRange</code> is
     * <code>true</code>, the auto-range flag is set to
     * <code>false</code> (normally when setting the axis range manually the
     * caller expects that range to remain in force).
     *
     * @param range the range (<code>null</code> not permitted).
     ...
     * side-effect, the auto-range flag is set to
     * <code>false</code>.
     *
     * @param lower the lower axis limit.
     * @param upper the upper axis limit.
