 ...
 * <p>Segments are group together to form a Segment Group. Each Segment Group
 * will contain a number of Segments included and a number of Segments excluded.
 * This Segment Group structure will repeat for the whole timeline.</p>
 * <p>For example, a working days SegmentedTimeline would be formed by a group
 * of 7 daily segments, where there are 5 included (Monday through Friday) and 2
 ...
 * <p>Additionally the {@code startTime}, or start of the first Segment of the
 ...
 * baseTimeline) would be a working day SegmentedTimeline (daily timeline Monday
 * through Friday). On top of this baseTimeline, a second one is defined that
 * maps the 9:00 AM to 4:00 PM period. Because the baseTimeline defines a
 * timeline of Monday through Friday, the resulting (combined) timeline will
 * expose the period 9:00 AM through 4:00 PM only on Monday through Friday, and
 * will remove all other intermediate intervals.</p>
