...
public abstract class ChartFactory {
     ...
     * the same key in
     * <code>previousDataset</code>. ie if value1 &gt; value2 then the section
     * will be in green (unless
     * <code>greenForIncrease</code> is
     * <code>false</code>, in which case it would be
     * <code>red</code>). Each section can have a shade of red or green as the
     * difference can be tailored between 0% (black) and percentDiffForMaxScale%
     * (bright red/green).
     * <p>
     * For instance if
     * <code>percentDiffForMaxScale</code> is 10 (10%), a difference of 5% will
