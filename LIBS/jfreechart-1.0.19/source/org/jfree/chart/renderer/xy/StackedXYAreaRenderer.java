 ...
 * correctly. This should get fixed at some point, but the current workaround is
 * to use the {@link StackedXYAreaRenderer2} class instead.
 */
public class StackedXYAreaRenderer extends XYAreaRenderer
     ...
     * <code>null</code> if using series paints.
     *
     ...
     * <code>null</code> if using series strokes.
     *
     ...
     *
     * @throws ClassCastException if <code>dataset</code> is not an instance of
     * {@link TableXYDataset}.
     */
    @Override
     ...
     * <code>StackedXYAreaRendererState</code> or <code>dataset</code> is not an
     * instance of {@link TableXYDataset}.
     */
    @Override
