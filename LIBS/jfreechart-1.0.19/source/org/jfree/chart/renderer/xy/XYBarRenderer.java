 ...
 * <code>XYBarChartDemo1.java</code> program included in the JFreeChart demo
 * collection:
 * <br><br>
...
public class XYBarRenderer extends AbstractXYItemRenderer
    ...
    /**
     * Sets the flag that controls whether or not the renderer draws shadows for
     * the bars, and sends a {@link RendererChangeEvent} to all registered
     * listeners.
     *
    ...
    /**
     * Sets the bar alignment factor and sends a {@link RendererChangeEvent} to
     * all registered listeners. If the alignment factor is outside the range
     * 0.0 to 1.0, no alignment will be performed by the renderer.
     *
    ...
    /**
     * Draws an item label. This method is provided as an alternative to null     {@link #drawItemLabel(Graphics2D, PlotOrientation, XYDataset, int, int,
    ...
    /**
     * Returns
     * <code>true</code> if the specified anchor point is inside a bar.
     *
