 ...
 * the {@link Cloneable} and
 * <code>PublicCloneable</code> interfaces.
 */
...
//    // FIXME: add setBaseFillPaint(int, Paint, boolean)?
     ...
     * passes control to the lookupSeriesOutlineStroke method. You can override
...
//    public void setBaseCreateEntities(boolean create, boolean notify);
    ...
    /**
     * Draws the specified
     * <code>marker</code> against the domain axis.
     *
     * @param g2 the graphics device.
     * @param plot the plot.
     * @param axis the value axis.
