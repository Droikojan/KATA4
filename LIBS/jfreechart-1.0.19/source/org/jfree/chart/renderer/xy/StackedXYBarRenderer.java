 ...
 * <code>StackedXYBarChartDemo2.java</code> program included in the JFreeChart
 * demo collection:
 * <br><br>
...
public class StackedXYBarRenderer extends XYBarRenderer {
    ...
    /**
     * Returns
     * <code>3</code> to indicate that this renderer requires three passes for
     * drawing (shadows are drawn in the first pass, the bars in the second, and
     * item labels are drawn in the third pass so that they always appear in
     * front of all the bars).
     *
     * @return <code>2</code>.
     */
    @Override
