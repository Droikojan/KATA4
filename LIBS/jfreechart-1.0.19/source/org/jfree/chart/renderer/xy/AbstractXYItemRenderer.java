...
public abstract class AbstractXYItemRenderer extends AbstractRenderer
    ...
    public XYItemLabelGenerator getItemLabelGenerator(int series, int item) {
        ...
        XYItemLabelGenerator generator = (XYItemLabelGenerator) this.itemLabelGeneratorMap.get(series);
        if (generator == null) {
    ...
    /**
     * Returns
     * <code>true</code> if the specified point (x, y) falls within or on the
     * boundary of the specified rectangle.
     *
     ...
     *         double, int, int, double, double, PlotOrientation)} -- see bug report
     * 1086307.
     */
    protected void updateCrosshairValues(CrosshairState crosshairState,
