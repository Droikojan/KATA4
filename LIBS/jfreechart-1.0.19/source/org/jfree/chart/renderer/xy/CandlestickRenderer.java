...
public class CandlestickRenderer extends AbstractXYItemRenderer
     ...
     * initialised, this field should never be set to
     * <code>null</code>.
     *
     * @since 1.0.7
     */
     ...
     *
     * @param candleWidth the candle width.
     * @param drawVolume a flag indicating whether or not volume bars should be
     * drawn.
     ...
     * <br>
     *
     * @param autoWidthMethod The method of automatically calculating the candle
     * width.
     *
