 ...
 * every data item - instead, it tries to plot only those data items that make a
 * difference to the visual output (the other data items are skipped). This
 * renderer is designed for use with the {@link XYPlot} class.
 *
 * @since 1.0.13
 */
public class SamplingXYLineRenderer extends AbstractXYItemRenderer
     ...
     * use the {@link #getBaseLegendShape()} method instead.
     */
    ...
    public static class State extends XYItemRendererState {
        ...
        /**
         * The minimum change in the x-value needed to trigger an update to the
         * seriesPath.
         */
        double dX = 1.0;
        /**
