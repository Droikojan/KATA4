...
/**
 * A line and shape renderer that can also display x and/or y-error values. This
 * renderer expects an {@link IntervalXYDataset}, otherwise it reverts to the
 * behaviour of the super class. The example shown here is generated by the
 * <code>XYErrorRendererDemo1.java</code> program included in the JFreeChart
 * demo collection:
 * <br><br>
...
public class XYErrorRenderer extends XYLineAndShapeRenderer {
    ...
    /**
     * The paint used to draw the error bars (if
     * <code>null</code> we use the series paint).
     */
    private transient Paint errorPaint;
    /**
     * The stroke used to draw the error bars (if
     * <code>null</code> we use the series outline stroke).
     *
     * @since 1.0.13
     */
    ...
    /**
     * Creates a new
     * <code>XYErrorRenderer</code> instance.
     */
     ...
     * for the x-values and, if the flag changes, sends a
    ...
    /**
     * Sets the flag that controls whether or not the renderer draws error bars
     * for the y-values and, if the flag changes, sends a
     * {@link RendererChangeEvent} to all registered listeners.
     *
     * @param draw the flag value.
     *
     ...
     * <code>null</code> (the default), the item outline stroke is used instead.
     *
