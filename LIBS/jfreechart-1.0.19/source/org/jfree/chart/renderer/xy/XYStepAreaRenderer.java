...
public class XYStepAreaRenderer extends AbstractXYItemRenderer
     ...
     * Constructs a new renderer.
     * <p>
     * To specify the type of renderer, use one of the constants: AREA, SHAPES
     * or AREA_AND_SHAPES.
     *
     ...
     * the step is drawn. The default is 1.0d, which means the step is drawn at
     * the domain position of the second`point. If the stepPoint is 0.5d the
    ...
    /**
     * Helper method which returns a value if it lies inside the visible
     * dataArea and otherwise the corresponding coordinate on the border of the
     * dataArea. The PlotOrientation is taken into account. Useful to avoid
     * possible sun.dc.pr.PRException: endPath: bad path which occurs when
     * trying to draw lines/shapes which in large part lie outside of the
     * visible dataArea.
     *
