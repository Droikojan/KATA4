...
/**
 * Area item renderer for an {@link XYPlot}. The example shown here is generated
 * by the
 * <code>XYAreaRenderer2Demo1.java</code> program included in the JFreeChart
 * demo collection:
 * <br><br>
...
public class XYAreaRenderer2 extends AbstractXYItemRenderer
     ...
     * Constructs a new renderer.
     *
     * @param labelGenerator the tool tip generator to use.  <code>null</code> is
     * none.
     ...
     *
     * @deprecated This method was included in the API by mistake and serves no
     * useful purpose. It has always returned <code>false</code>.
     *
     */
