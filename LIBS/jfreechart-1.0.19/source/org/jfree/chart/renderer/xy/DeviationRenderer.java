...
/**
 * A specialised subclass of the {@link XYLineAndShapeRenderer} that requires an
 * {@link IntervalXYDataset} and represents the y-interval by shading an area
 * behind the y-values on the chart. The example shown here is generated by the
 * <code>DeviationRendererDemo1.java</code> program included in the JFreeChart
 * demo collection:
 * <br><br>
...
public class DeviationRenderer extends XYLineAndShapeRenderer {
    ...
    /**
     * Creates a new renderer that displays lines and shapes for the data items,
     * as well as the shaded area for the y-interval.
     */
    ...
    /**
     * This method is overridden so that this flag cannot be changed---it is set
     * to
     * <code>true</code> for this renderer.
     *
     * @param flag ignored.
     */
    @Override
    ...
    /**
     * Returns
     * <code>true</code> if this is the pass where the shapes are drawn.
     *
    ...
    /**
     * Returns
     * <code>true</code> if this is the pass where the lines are drawn.
     *
     * @param pass the pass index.
     *
     * @return A boolean.
