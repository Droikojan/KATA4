 ...
 * filled areas, or (e) filled areas and shapes. The example shown here is
 * generated by the
 * <code>XYAreaRendererDemo1.java</code> program included in the JFreeChart demo
 * collection:
 * <br><br>
...
public class XYAreaRenderer extends AbstractXYItemRenderer
    ...
    /**
     * A flag that can be set to specify that the fill paint should be used to
     * fill the area under the renderer.
     *
     * @since 1.0.14
     */
    private boolean useFillPaint;
    /**
     * A transformer that is applied to the paint used to fill under the area
     * *if* it is an instance of GradientPaint.
     *
     * @since 1.0.14
     */
    ...
    /**
     * Sets the flag that controls whether or not the series fill paint is used
     * to fill the area under the line and sends a {@link RendererChangeEvent}
     * to all listeners.
     *
