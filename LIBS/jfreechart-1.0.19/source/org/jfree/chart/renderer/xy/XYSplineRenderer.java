 ...
 * {@link XYPlot} class. The example shown here is generated by the
...
public class XYSplineRenderer extends XYLineAndShapeRenderer {
    ...
    /**
     * Represents state information that applies to a single rendering of a
     * chart.
     */
    ...
    /**
     * Creates a new instance with the precision attribute defaulting to 5 and
     * no fill of the area 'under' the spline.
     */
    ...
    /**
     * Creates a new renderer with the specified precision and specified fill of
     * the area 'under' (between '0' and) the spline.
     *
     * @param precision the number of points between data items.
     * @param fillType the type of fill beneath the curve (<code>null</code> not
     * permitted).
     *
     * @since 1.0.17
     */
    ...
    /**
     * Returns the number of line segments used to approximate the spline curve
     * between data points.
     *
    ...
    /**
     * Set the fill type and sends a {@link RendererChangeEvent} to all
    ...
    /**
     * Returns the gradient paint transformer, or
     * <code>null</code>.
     *
