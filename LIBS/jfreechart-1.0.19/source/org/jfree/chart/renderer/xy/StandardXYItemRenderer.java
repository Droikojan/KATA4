...
public class StandardXYItemRenderer extends AbstractXYItemRenderer
    ...
    /**
     * The shape that is used to represent a line in the legend. This should
     * never be set to
     * <code>null</code>.
     */
     ...
     * @since 1.0.5
     *
     * @deprecated As of 1.0.8, you should avoid using this method and rely on
     * just the per-series ({@link #getSeriesShapesFilled(int)}) and base-level
     * ({@link #getBaseShapesFilled()}) settings.
     */
    ...
    /**
     * Sets the override flag that controls whether or not shapes are filled for
     ...
     *
     * @deprecated As of 1.0.8, you should avoid using this method and rely on
     * just the per-series ({@link #setSeriesShapesFilled(int,
     ...
     * point and sends a {@link RendererChangeEvent} to all registered
     * listeners.
     *
     * @param flag the flag.
     *
    ...
    /**
     * Returns the hotspot of the image used to draw a single data item. The
     * hotspot is the point relative to the top left of the image that should
     * indicate the data item. The default is the center of the image.
     *
     * @param plot the plot (can be used to obtain standard color information
     * etc).
