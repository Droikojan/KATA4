...
public abstract class AbstractRenderer implements Cloneable, Serializable {
    ...
    /**
     * The base shape for legend items. If this is
     * <code>null</code>, the series shape will be used.
     *
     * @since 1.0.11
     */
    ...
    /**
     * Returns
     * <code>true</code> if the specified object is registered with the dataset
     * as a listener. Most applications won't need to call this method, it
     ...
     * default settings - you must set it to
     * <code>null</code> if you want the other settings to apply.
     *
     * @return The flag (possibly <code>null</code>).
     *
