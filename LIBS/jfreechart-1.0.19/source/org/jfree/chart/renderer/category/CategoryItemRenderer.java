 ...
 * 1 setting is
 * <code>null</code>, the renderer will look up the final layer, which provides
 * a default or "base" setting. Some attributes allow the base setting to be
 * <code>null</code>, while other attributes enforce non-
...
public interface CategoryItemRenderer extends LegendItemSource {
    ...
    /**
     * Returns
     * <code>true</code> if the series should be shown in the legend, and
...
//    public void setBaseFillPaint(Paint paint);
    ...
    /**
     * Returns
     * <code>true</code> if an item label is visible, and
     * <code>false</code> otherwise.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the item labels for a series are visible, and
     * <code>false</code> otherwise.
     *
     * @param series the series index (zero-based).
     *
    ...
    /**
     * Returns the base setting for item label visibility. A
     * <code>null</code> result should be interpreted as equivalent to
     * <code>Boolean.FALSE</code> (this is an error in the API design, the
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on {@link #getSeriesToolTipGenerator(int)} and
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on null     {@link #setSeriesPositiveItemLabelPosition(int, ItemLabelPosition,
     ...
     *
     * @deprecated This method should no longer be used (as of version 1.0.6).
     * It is sufficient to rely on null     {@link #setSeriesNegativeItemLabelPosition(int, ItemLabelPosition,
