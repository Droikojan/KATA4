...
/**
 * A renderer that draws stacked area charts for a {@link CategoryPlot}. The
 * example shown here is generated by the
 * <code>StackedAreaChartDemo1.java</code> program included in the JFreeChart
 * Demo Collection:
 * <br><br>
...
public class StackedAreaRenderer extends AreaRenderer
     ...
     * percentage (so that the stacked areas add to 100%), and
     ...
     * as a percentage (so that the stacked areas add to 100%), and sends a
     ...
     * <code>2</code>) required by this renderer. The first pass is used to draw
     * the areas, the second pass is used to draw the item labels (if visible).
     *
     ...
     * <code>series</code> for the specified item. It returns [0.0, 0.0] if
     * <code>series</code> is the first series.
     *
     * @param dataset the dataset (<code>null</code> not permitted).
     ...
     * for all series values up to but excluding <code>series</code> * for <code>index</code>.
     */
     ...
     * the mean of the supplied values, unless either of the supplied values is
     * zero, in which case the adjusted value is zero also.
     *
     * @param stack1 the first stack pair.
     * @param stack2 the second stack pair.
     *
     ...
     * <code>series</code> for the specified category,
     * <code>category</code>. It returns 0.0 if
     ...
     * but excluding <code>series</code> for Object <code>category</code>.
     *
