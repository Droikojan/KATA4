 ...
 * the
 * <code>StatisticalLineChartDemo1.java</code> program included in the
...
public class StatisticalLineAndShapeRenderer extends LineAndShapeRenderer
    ...
    /**
     * The stroke used to draw the error indicators. If null, the renderer will
     * use the itemOutlineStroke.
     *
     * @since 1.0.13
     */
     ...
     * <code>null</code>, the item paint is used instead) and sends a
     ...
     * <code>null</code>, the item outline stroke is used instead) and sends a
     * {@link RendererChangeEvent} to all registered listeners.
     *
