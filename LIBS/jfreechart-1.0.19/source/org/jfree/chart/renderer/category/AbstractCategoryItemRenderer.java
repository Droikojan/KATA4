...
public abstract class AbstractCategoryItemRenderer extends AbstractRenderer
     ...
     * renderer. This method returns
     * <code>1</code>, subclasses should override if they need more passes.
     *
    ...
    /**
     * Creates a new state instance---this method is called from the null     {@link #initialise(Graphics2D, Rectangle2D, CategoryPlot, int,
     * PlotRenderingInfo)} method. Subclasses can override this method if they
     * need to use a subclass of {@link CategoryItemRendererState}.
     *
     ...
     * return
     * <code>null</code> if {@link #isSeriesVisible(int)} or
     * {@link #isSeriesVisibleInLegend(int)} returns
     * <code>false</code>.
     *
     ...
     * @param negative indicates a negative value (which affects the item label
     * position).
     */
     ...
     * <code>plot</code> reference is shallow copied.
     *
     * @return A clone.
     *
     * @throws CloneNotSupportedException can be thrown if one of the objects
     * belonging to the renderer does not support cloning (for example, an item
     * label generator).
     */
    @Override
