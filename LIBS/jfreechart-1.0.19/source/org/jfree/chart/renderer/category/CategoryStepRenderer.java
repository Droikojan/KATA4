 ...
 * the {@link CategoryPlot} class. The example shown here is generated by the
 * <code>CategoryStepChartDemo1.java</code> program included in the JFreeChart
 * Demo Collection:
 * <br><br>
...
public class CategoryStepRenderer extends AbstractCategoryItemRenderer
    ...
    /**
     * Creates a new renderer (stagger defaults to
     * <code>false</code>).
     */
    ...
    /**
     * Creates a new state instance. This method is called from null     {@link #initialise(Graphics2D, Rectangle2D, CategoryPlot, int,
     * PlotRenderingInfo)}, and we override it to ensure that the state contains
     * a working Line2D instance.
     *
     ...
     * addition of the 'state' parameter. This is an incompatible change, but is
     * considered a low risk because it is unlikely that anyone has subclassed
     * this renderer. If this *does* cause trouble for you, please report it as
     * a bug.
     *
