 ...
 * <code>BoxAndWhiskerChartDemo1.java</code> program included in the JFreeChart
 * Demo Collection:
 * <br><br>
...
public class BoxAndWhiskerRenderer extends AbstractCategoryItemRenderer
    ...
    /**
     * A flag that, if
     * <code>true</code>, causes the whiskers to be drawn using the outline
     * paint for the series. The default value is
     ...
     * <code>true</code>, causes the whiskers to be drawn using the series
     * outline paint.
     *
     * @return A boolean.
     *
     ...
     * <code>true</code>, causes the whiskers to be drawn using the series
     * outline paint, and sends a {@link RendererChangeEvent} to all registered
     * listeners.
     *
