...
/**
 * A stacked bar renderer for use with the {@link CategoryPlot} class. The
 * example shown here is generated by the
 * <code>StackedBarChartDemo1.java</code> program included in the JFreeChart
 * Demo Collection:
 * <br><br>
...
public class StackedBarRenderer extends BarRenderer
     ...
     * <code>3</code>) required by this renderer. The first pass is used to draw
     * the bar shadows, the second pass is used to draw the bars, and the third
     * pass is used to draw the item labels (if visible).
     *
