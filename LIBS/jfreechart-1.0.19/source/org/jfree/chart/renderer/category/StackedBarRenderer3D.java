 ...
 * <code>StackedBarChart3DDemo1.java</code> program included in the JFreeChart
 * Demo Collection:
 * <br><br>
...
public class StackedBarRenderer3D extends BarRenderer3D
    ...
    /**
     * Returns
     * <code>true</code> if the renderer displays each item value as a
     * percentage (so that the stacked bars add to 100%), and
    ...
    /**
     * Returns the flag that controls whether or not zero values are drawn by
     * the renderer.
     *
     * @return A boolean.
     *
    ...
    /**
     * Returns a list containing the stacked values for the specified series in
     * the given dataset, plus the supplied base value.
     *
     * @param dataset the dataset (<code>null</code> not permitted).
     * @param category the category key (<code>null</code> not permitted).
     * @param base the base value.
     * @param asPercentages a flag that controls whether the values in the list
     * are converted to percentages of the total.
     *
