 ...
 * {@link CategoryPlot} class. Some quirks to note:
 * <ul>
 * <li>the value in the last category of the dataset should be (redundantly)
 * specified as the sum of the items in the preceding categories - otherwise the
 * final bar in the plot will be incorrectly plotted;</li>
 ...
 * <code>WaterfallChartDemo1.java</code> program included in the JFreeChart Demo
 * Collection:
 * <br><br>
...
public class WaterfallBarRenderer extends BarRenderer {
    ...
    /**
     * Sets the paint that will be used to draw bars having negative values, and
