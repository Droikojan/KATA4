 ...
 * value and a standard deviation line. The example shown here is generated by
 * the
 * <code>StatisticalBarChartDemo1.java</code> program included in the JFreeChart
 * Demo Collection:
 * <br><br>
...
public class StatisticalBarRenderer extends BarRenderer
     ...
     * <code>null</code>, the item outline paint is used instead) and sends a
     ...
     * {@link RendererChangeEvent} to all registered listeners. If you set this
     * to
     * <code>null</code>, the renderer will use the item outline stroke.
     *
