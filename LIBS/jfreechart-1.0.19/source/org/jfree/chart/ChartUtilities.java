...
public abstract class ChartUtilities {
     ...
     * will contain the tooltip text (<code>null</code> not permitted * if <code>info</code> contains tooltip information).
    ...
    /**
     * Creates an HTML image map. This method maps to null     {@link ImageMapUtilities#getImageMap(String, ChartRenderingInfo,
    ...
    /**
     * Creates an HTML image map. This method maps directly to null     {@link ImageMapUtilities#getImageMap(String, ChartRenderingInfo,
     * ToolTipTagFragmentGenerator, URLTagFragmentGenerator)}.
     *
     * @param name the map name (<code>null</code> not permitted).
     * @param info the chart rendering info (<code>null</code> not permitted).
