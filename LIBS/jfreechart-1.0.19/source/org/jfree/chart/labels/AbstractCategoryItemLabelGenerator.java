...
public abstract class AbstractCategoryItemLabelGenerator
    ...
    /**
     * The label format string used by a
     * <code>MessageFormat</code> object to combine the standard items: {0} =
     * series name, {1} = category, {2} = value, {3} = value as a percentage of
     * the column total.
     */
