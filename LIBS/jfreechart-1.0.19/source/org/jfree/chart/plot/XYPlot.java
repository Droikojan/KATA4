...
public class XYPlot extends Plot implements ValueAxisPlot, Pannable, Zoomable,
    ...
    /**
     * Creates a new
     * <code>XYPlot</code> instance with no dataset, no axes and no renderer.
     * You should specify these items before using the plot.
     */
    public XYPlot() {
     ...
     * registered listeners. If the renderer is set to
