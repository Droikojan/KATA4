...
public class DialTextAnnotation extends AbstractDialLayer implements DialLayer,
    ...
    /**
     * Sets the label and sends a {@link DialLayerChangeEvent} to all registered
     * listeners.
     *
     * @param label the label (<code>null</code> not permitted).
     *
    ...
    /**
     * Returns the radius used to calculate the anchor point. This is specified
     * as a percentage relative to the dial's framing rectangle.
     *
     * @return The radius.
     *
     * @see #setRadius(double)
