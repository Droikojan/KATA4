...
/**
 * A regular dial layer that can be used to draw a cap over the center of the
 * dial (the base of the dial pointer(s)).
 *
 * @since 1.0.7
 */
public class DialCap extends AbstractDialLayer implements DialLayer, Cloneable,
     ...
     * <code>null</code>). This field is transient because it requires special
     * handling for serialization.
     */
     ...
     * <code>StandardDialBackground</code>. The default background paint is
     ...
     * @return A clone.
     *
     * @throws CloneNotSupportedException if some attribute of the cap cannot be
     * cloned.
     */
    @Override
