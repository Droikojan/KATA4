...
public class StandardDialRange extends AbstractDialLayer implements DialLayer,
    ...
    /**
     * The factor (in the range 0.0 to 1.0) that determines the inside limit of
     * the range highlight.
     */
    ...
    /**
     * Sets the bounds for the range and sends a {@link DialLayerChangeEvent} to
