...
public class StandardDialScale extends AbstractDialLayer implements DialScale,
    ...
    /**
     * The factor (in the range 0.0 to 1.0) that determines the outside limit of
     * the tick marks.
     */
    ...
    /**
     * The factor that is subtracted from the tickRadius to determine the inner
     * point of the major ticks.
     */
    private double majorTickLength;
    /**
     * The paint to use for major tick marks. This field is transient because it
     * requires special handling for serialization.
     */
    ...
    /**
     * The factor that is subtracted from the tickRadius to determine the inner
     * point of the minor ticks.
     */
    private double minorTickLength;
    /**
     * The paint to use for minor tick marks. This field is transient because it
     * requires special handling for serialization.
     */
    ...
    /**
     * The tick label paint. This field is transient because it requires special
     ...
     * @param startAngle the start angle (in degrees, using the same orientation
     * as Java's <code>Arc2D</code> class).
     * @param extent the extent (in degrees, counter-clockwise).
     * @param majorTickIncrement the interval between major tick marks (must be
     * &gt; 0).
     * @param minorTickCount the number of minor ticks between major tick marks.
     */
     ...
     * subtracted from the tick radius to determine the inner starting point for
     * the tick marks.
     *
    ...
    /**
     * Sets the major tick paint and sends a {@link DialLayerChangeEvent} to all
     * registered listeners.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the tick labels should be displayed, and
    ...
    /**
     * Sets the flag that controls whether or not the tick labels are displayed,
    ...
    /**
     * Sets a flag that controls whether or not the first tick label is visible,
     * and sends a {@link DialLayerChangeEvent} to all registered listeners.
     *
     * @param visible the new flag value.
     *
    ...
    /**
     * Returns
     * <code>true</code> to indicate that this layer should be clipped within
     * the dial window.
     *
     ...
     * @param frame the reference frame that is used to construct the geometry
     * of the plot (<code>null</code> not permitted).
    ...
    /**
     * Tests this
     * <code>StandardDialScale</code> for equality with an arbitrary object.
     *
