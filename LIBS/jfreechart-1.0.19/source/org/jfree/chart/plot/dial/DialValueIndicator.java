...
public class DialValueIndicator extends AbstractDialLayer implements DialLayer,
    ...
    /**
     * A data value that will be formatted to determine the maximum size of the
     * indicator bounds. If this is null, the indicator bounds can grow as large
     * as necessary to contain the actual data value.
     *
     * @since 1.0.14
     */
    ...
    /**
     * Returns the angle for the anchor point. The angle is specified in degrees
     * using the same orientation as Java's
    ...
    /**
     * Sets the template value and sends a {@link DialLayerChangeEvent} to all
     * registered listeners.
     *
    ...
    /**
     * Sets the template value for the maximum size of the indicator bounds and
    ...
    /**
     * Sets the paint and sends a {@link DialLayerChangeEvent} to all registered
     * listeners.
     *
    ...
    /**
     * Sets the background paint and sends a {@link DialLayerChangeEvent} to all
     * registered listeners.
     *
     * @param paint the paint (<code>null</code> not permitted).
     *
    ...
    /**
     * Sets the outline stroke and sends a {@link DialLayerChangeEvent} to all
     * registered listeners.
     *
    ...
    /**
     * Draws the background to the specified graphics device. If the dial frame
     * specifies a window, the clipping region will already have been set to
     * this window before this method is called.
     *
