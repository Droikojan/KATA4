...
public abstract class DialPointer extends AbstractDialLayer
    ...
    /**
     * Creates a new
     * <code>DialPointer</code> instance.
     */
    ...
    /**
     * Returns the radius of the pointer, as a percentage of the dial's framing
     * rectangle.
     *
     * @return The radius.
     *
    ...
    /**
     * Sets the radius of the pointer and sends a {@link DialLayerChangeEvent}
     ...
     * @return a clone.
     *
     * @throws CloneNotSupportedException if one of the attributes cannot be
     * cloned.
     */
    @Override
    ...
    public static class Pointer extends DialPointer {
        ...
        /**
         * Sets the width radius and sends a {@link DialLayerChangeEvent} to all
         * registered listeners.
         *
         * @param radius the radius
         *
