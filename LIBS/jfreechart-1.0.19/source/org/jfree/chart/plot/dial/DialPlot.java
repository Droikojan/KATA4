...
/**
 * A dial plot composed of user-definable layers. The example shown here is
 * generated by the
 * <code>DialDemo2.java</code> program included in the JFreeChart Demo
 * Collection:
 * <br><br>
 * <img src="../../../../../images/DialPlotSample.png" alt="DialPlotSample.png">
 *
 * @since 1.0.7
 */
public class DialPlot extends Plot implements DialLayerChangeListener {
    ...
    /**
     * Returns the x-coordinate of the viewing rectangle. This is specified in
     * the range 0.0 to 1.0, relative to the dial's framing rectangle.
     *
    ...
    /**
     * Returns the y-coordinate of the viewing rectangle. This is specified in
     * the range 0.0 to 1.0, relative to the dial's framing rectangle.
     *
    ...
    /**
     * Returns the width of the viewing rectangle. This is specified in the
     * range 0.0 to 1.0, relative to the dial's framing rectangle.
     *
    ...
    /**
     * Returns the height of the viewing rectangle. This is specified in the
     * range 0.0 to 1.0, relative to the dial's framing rectangle.
     *
    ...
    /**
     * Sets the viewing rectangle, relative to the dial's framing rectangle, and
    ...
    /**
     * Returns the dial pointer that is associated with the specified dataset,
     * or
     * <code>null</code>.
     *
     ...
     * @param anchor the anchor point (typically the last point that the mouse
    ...
    /**
     * Adds a dial scale to the plot and sends a {@link PlotChangeEvent} to all
     * registered listeners.
     *
    ...
    /**
     * Tests this
     * <code>DialPlot</code> instance for equality with an arbitrary object. The
     * plot's dataset(s) is (are) not included in the test.
     *
