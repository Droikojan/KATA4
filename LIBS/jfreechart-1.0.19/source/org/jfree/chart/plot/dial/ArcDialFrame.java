...
public class ArcDialFrame extends AbstractDialLayer implements DialFrame,
    ...
    /**
     * The stroke for drawing the frame outline. This field is transient because
     ...
     * <code>ArcDialFrame</code> that spans 180 degrees.
     */
    public ArcDialFrame() {
        this(0, 180);
    }
    ...
    /**
     * Creates a new instance of
     * <code>ArcDialFrame</code> that spans the arc specified.
     *
    ...
    /**
     * Sets the foreground paint and sends a {@link DialLayerChangeEvent} to all
     * registered listeners.
     *
     * @param paint the paint (<code>null</code> not permitted).
     *
    ...
    /**
     * Sets the start angle and sends a {@link DialLayerChangeEvent} to all
     * registered listeners.
     *
    ...
    /**
     * Returns
     * <code>false</code> to indicate that this dial layer is not clipped to the
     * dial window.
     *
