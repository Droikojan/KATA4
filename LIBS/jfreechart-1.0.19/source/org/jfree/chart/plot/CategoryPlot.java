...
public class CategoryPlot extends Plot implements ValueAxisPlot, Pannable,
     ...
     * <code>-1</code> if the axis is not assigned to the plot.
     *
     ...
     * listeners.
     * <p>
     * You can set the renderer to
     * <code>null</code>, but this is not recommended because:
     * <ul>
     ...
     * belong to the plot, this method will return
     * <code>null</code>.
     *
     * @param dataset the dataset (<code>null</code> permitted).
     *
     ...
     * <code>Stroke</code>) used to draw the crosshair (if visible).
     *
    ...
    /**
     * Sets the pen-style (
     * <code>Stroke</code>) used to draw the range crosshair (if visible), and
     * sends a {@link PlotChangeEvent} to all registered listeners.
     *
    ...
    /**
     * Returns
     * <code>false</code> always, because the plot cannot be panned along the
     * domain axis/axes.
     *
     * @return A boolean.
     *
    ...
    /**
     * Returns
     * <code>false</code> to indicate that the domain axes are not zoomable.
     *
     * @return A boolean.
     *
     * @see #isRangeZoomable()
    ...
    /**
     * Returns
     * <code>true</code> to indicate that the range axes are zoomable.
     *
     * @return A boolean.
     *
     ...
     * <code>CategoryPlot</code> doesn't support zooming on the domain.
     *
