...
public class MultiplePiePlot extends Plot implements Cloneable, Serializable {
     ...
     * aggregated items. The default value is
     ...
     * <code>sectionPaints</code> cache to see if a paint is associated with
     * that key and, if not, fetch one from the drawing supplier. These colors
     * are cached so that the legend and all the subplots use consistent colors.
     */
