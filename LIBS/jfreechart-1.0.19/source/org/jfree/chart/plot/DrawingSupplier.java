 ...
 * <code>Shape</code> objects for use by plots and renderers. By providing a
 * central place for obtaining these items, we can ensure that duplication is
 * avoided.
 * <p>
...
public interface DrawingSupplier {
    ...
    /**
     * Returns the next
     * <code>Stroke</code> object in a sequence maintained by the supplier.
     *
     * @return The stroke.
     */
    ...
    /**
     * Returns the next
     * <code>Shape</code> object in a sequence maintained by the supplier.
     *
     * @return The shape.
     */
