 ...
 * <code>PieChartDemo2.java</code> program included in the JFreeChart Demo
 * Collection:
 * <br><br>
...
public class PiePlot extends Plot implements Cloneable, Serializable {
    ...
    /**
     * The shadow generator for the plot (
     * <code>null</code> permitted).
     *
     * @since 1.0.14
     */
    ...
    /**
     * Creates a new plot. The dataset is initially set to
     * <code>null</code>.
     */
    public PiePlot() {
        this(null);
     ...
     * <code>null</code> values in the dataset are ignored.
     *
     * @return A boolean.
     *
     ...
     * <code>null</code> values are ignored, and sends a {@link PlotChangeEvent}
     * to all registered listeners. At present, this only affects whether or not
     * the key is presented in the legend.
     *
     * @param flag the flag.
     *
     ...
     * steps:
     * <ul>
     * <li>if {@link #getSectionPaint()} is non-
     * <code>null</code>, return it;</li>
     * <li>if {@link #getSectionPaint(int)} is non-
     * <code>null</code> return it;</li>
     * <li>if {@link #getSectionPaint(int)} is
     * <code>null</code> but
     * <code>autoPopulate</code> is
     * <code>true</code>, attempt to fetch a new paint from the drawing supplier
     ...
     * the
     * <code>autoPopulateSectionPaint</code> flag is set, the section paints may
     * be repopulated using the same colours as before.
     *
     * @param notify notify listeners?
     *
     * @since 1.0.11
     ...
     * defined, which is rare. The default value is
     ...
     * to
     * <code>lookupSectionPaint(section,
     ...
     * these steps:
     * <ul>
     * <li>if {@link #getSectionOutlinePaint()} is non-
     * <code>null</code>, return it;</li>
     * <li>otherwise, if {@link #getSectionOutlinePaint(int)} is non-
     * <code>null</code> return it;</li>
     * <li>if {@link #getSectionOutlinePaint(int)} is
     * <code>null</code> but
     * <code>autoPopulate</code> is
     * <code>true</code>, attempt to fetch a new outline paint from the drawing
     * supplier ({@link #getDrawingSupplier()});
     ...
     * to
     * <code>lookupSectionOutlineStroke(section,
     ...
     * these steps:
     * <ul>
     * <li>if {@link #getSectionOutlineStroke()} is non-
     * <code>null</code>, return it;</li>
     * <li>otherwise, if {@link #getSectionOutlineStroke(int)} is non-
     * <code>null</code> return it;</li>
     * <li>if {@link #getSectionOutlineStroke(int)} is
     * <code>null</code> but
     * <code>autoPopulate</code> is
     * <code>true</code>, attempt to fetch a new outline stroke from the drawing
     * supplier ({@link #getDrawingSupplier()});
     ...
     * registered listeners. Set the generator to
     * <code>null</code> if you don't want any tool tips.
     *
     * @param generator the generator (<code>null</code> permitted).
     *
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        clone.explodePercentages = new TreeMap<Comparable<?>, Number>(this.explodePercentages);
        if (this.labelGenerator != null) {
