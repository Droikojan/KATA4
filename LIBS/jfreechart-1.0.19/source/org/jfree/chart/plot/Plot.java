...
public abstract class Plot implements AxisChangeListener,
    ...
    /**
     * The parent plot (
     * <code>null</code> if this is the root plot).
     */
    private Plot parent;
    /**
     ...
     * <code>null</code> if this plot is not part of a combined plot).
     *
    ...
    /**
     * Returns
     * <code>true</code> if this plot is part of a combined plot structure (that
     * is, {@link #getParent()} returns a non-
     * <code>null</code> value), and
     ...
     * <code>true</code>. Note that for historical reasons, the plot's outline
     * paint and stroke can take on
     * <code>null</code> values, in which case the outline will not be drawn
     * even if this flag is set to
     * <code>true</code>.
     *
     ...
     * attribute to
     * <code>null</code>, no outline will be drawn.
     *
     ...
     * paint is an instance of
     * <code>GradientPaint</code>, the gradient will run in the direction
     * suggested by the plot's orientation.
     *
