 ...
 *
 * WARNING: THIS CLASS IS NOT PART OF THE STANDARD JFREECHART API AND IS SUBJECT
 * TO ALTERATION OR REMOVAL. DO NOT RELY ON THIS CLASS FOR PRODUCTION USE.
 * Please experiment with this code and provide feedback.
 */
public class XYSmoothLineAndShapeRenderer extends XYLineAndShapeRenderer {
     ...
     * draws the shapes which mark the item positions. If
     * <code>entities</code> is not
     * <code>null</code> it will be populated with entity information for points
