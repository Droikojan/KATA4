...
public class SWTUtils {
    ...
    /**
     * Create a
     * <code>FontData</code> object which encapsulate the essential data to
     * create a swt font. The data is taken from the provided awt Font.
     * <p>Generally speaking, given a font size, the returned swt font will
     * display differently on the screen than the awt one. Because the SWT
     * toolkit use native graphical resources whenever it is possible, this fact
     * is platform dependent. To address this issue, it is possible to enforce
     * the method to return a font with the same size (or at least as close as
     * possible) as the awt one.
     * <p>When the object is no more used, the user must explicitly call the
     ...
     * provided swt
     * <code>FontData</code>.
     * <p>Generally speaking, given a font size, an swt font will display
    ...
    /**
     * Creates an AWT
     * <code>MouseEvent</code> from a swt event. This method helps passing SWT
     * mouse event to awt components.
     *
    ...
    /**
     * Converts a buffered image to SWT
     * <code>ImageData</code>.
     *
