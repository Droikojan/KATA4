...
public class SWTGraphics2D extends Graphics2D {
     ...
     * <code>fillRectangle</code> method of the
     * <code>GC</code> class uses the background color so we must switch colors.
     *
    ...
    /**
     * Returns
     * <code>true</code> if the rectangle (in device space) intersects with the
     * shape (the interior, if
     * <code>onStroke</code> is false, otherwise the stroked outline of the
     * shape).
     *
