...
public class StatisticalBarRendererTest {
    ...
    /**
     * Draws the chart with a
     * <code>null</code> mean value to make sure that no exceptions are thrown
     * (particularly by code in the renderer). See bug report 1779941.
     */
    @Test
    ...
    /**
     * Draws the chart with a
     * <code>null</code> standard deviation to make sure that no exceptions are
     * thrown (particularly by code in the renderer). See bug report 1779941.
     */
    @Test
